...
//    row("tenth amplitude",   block.channels.map { it.DitherAmplitude })
//    row("tenth frequency",   block.channels.map { it.DitherFrequency })
//    row("MinValue",          block.channels.map { it.minValue })
//    row("MaxValue",          block.channels.map { it.maxValue })
//    row("isVisible",         block.channels.map { it.isVisible })
//    return r
...
//                    DitherAmplitude = sheet.getRow(cursor + 4).getCell(1 + i).numericCellValue.toInt(),
//                    DitherFrequency = sheet.getRow(cursor + 5).getCell(1 + i).numericCellValue.toInt(),
